...
# Insert extended keywords into the MongoDB collection in batches
batch_size = 20
for i in range(0, len(extended_keyword_list), batch_size):
    batch = extended_keyword_list[i:i + batch_size]
    keywords_collection.insert_many([{"keyword": kw} for kw in batch])
